...
PRODUCTS = [
    ...
    {"slug": "soft-life-morning-routine-guide", "title": "Soft Life Morning Routine Guide", "subtitle": "Start her day like she means it.", "type": "Guide", "collection": "soft_life", "life_area": "soft_life", "price": 9, "description": 'Building a calm, realistic morning routine that sets the tone for her whole day.', "best_for": 'A woman whose mornings feel rushed, reactive, or glued to her phone.', "outcome": 'A morning routine she actually enjoys and can keep, even on busy days.'},
    {"slug": "soft-life-night-routine-guide", "title": "Soft Life Night Routine Guide", "subtitle": "Wind down like the boss she is.", "type": "Guide", "collection": "soft_life", "life_area": "soft_life", "price": 9, "description": 'Winding down each evening so she sleeps better and wakes up ready.', "best_for": 'A woman who stays up scrolling, goes to bed stressed, or wakes up tired.', "outcome": 'A soothing night routine that helps her rest and prepare for tomorrow.'},
    {"slug": "weekly-reset-checklist", "title": "The Weekly Reset Checklist", "subtitle": "Sunday reset, simplified.", "type": "Checklist", "collection": "soft_life", "life_area": "soft_life", "price": 7, "description": 'Resetting her space, schedule, money, and mind every week in under an hour.', "best_for": 'A woman who wants a simple Sunday ritual to start each week fresh.', "outcome": 'A repeatable weekly reset that keeps life from piling up.'},
    ...
    {"slug": "soft-life-goal-setting-workbook", "title": "Soft Life Goal-Setting Workbook", "subtitle": "Turn her vision into a plan.", "type": "Workbook", "collection": "soft_life", "life_area": "goals", "price": 15, "description": 'Deciding what she really wants and setting goals that fit her soft life.', "best_for": 'A woman who wants goals that feel meaningful, not stressful.', "outcome": 'Clear, aligned goals and the first steps to reach them.'},
    {"slug": "dream-life-vision-planner", "title": "The Dream Life Vision Planner", "subtitle": "Design the life she's dreaming of.", "type": "Planner", "collection": "soft_life", "life_area": "goals", "price": 17, "description": "Getting clear on the life she's dreaming of across every area, from home to career to love.", "best_for": 'A woman who wants to picture her dream life in detail before planning it.', "outcome": 'A vivid, written vision of her dream life she can come back to all year.'},
    ...
    {"slug": "soft-life-journal", "title": "The Soft Life Journal", "subtitle": "A private space for her thoughts.", "type": "Digital Journal", "collection": "inner_life", "life_area": "inner_life", "price": 12, "description": 'Giving her a private space to process her thoughts, feelings, and growth.', "best_for": "A woman who wants to journal but doesn't know what to write.", "outcome": 'A regular journaling habit and more clarity about herself.'},
